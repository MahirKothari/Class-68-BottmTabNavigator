...
import {View, Text, StyleSheet, TouchableOpacity, TextInput, Image, Alert,ToastAndroid,FlatList} from 'react-native';
        ...
        return(
            <View style={styles.container}>
              <View style={styles.searchBar}>
                  <TextInput style={styles.bar} placeholder = 'enter BookId or StudentId' onChangeText = {(text)=>{this.setState({
                      search:text
                  })}}>
                  </TextInput>
